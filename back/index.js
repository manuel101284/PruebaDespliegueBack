...
const todoRoutes = require("./back/routes/todoRoutes");
...
mongoose.connect("mongodb + srv://manuelricardo:castellanos@cluster0.pcwd49f.mongodb.net/?retryWrites=true&w=majority", connectionOptions)
